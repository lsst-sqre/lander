...
\newcommand{\docRef}{RTN-126}
\newcommand{\docUpstreamLocation}{\url{https://github.com/lsst/rtn-126}}
...
\input{authors}
\date{\today}
\title{Point Spread Function Characterization of the Vera C. Rubin Observatory using the Data Preview 2 dataset.}

% This can write metadata into the PDF.
% Update keywords and author information as necessary.
\hypersetup{
    pdftitle={Point Spread Function Characterization of the Vera C. Rubin Observatory using the Data Preview 2 dataset.},
    pdfauthor={legetp},
    pdfkeywords={}
}
